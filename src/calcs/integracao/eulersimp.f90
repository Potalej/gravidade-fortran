...
MODULE eulersimp
  ...
  IMPLICIT NONE
  PRIVATE
  PUBLIC integracao_eulersimp

  TYPE, EXTENDS(integracao) :: integracao_eulersimp
...
SUBROUTINE Iniciar (self, massas, G, h, potsoft, corrigir, corme, cormnt, colidir, colmd)
  IMPLICIT NONE
  class(integracao_eulersimp), INTENT(INOUT) :: self
...
FUNCTION forcas (self, R)
  IMPLICIT NONE
  class(integracao_eulersimp), INTENT(IN) :: self
